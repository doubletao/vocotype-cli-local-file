# VocoType CLI 修改版 — 离线语音转文字工具

<h2 align="center">本地离线，多语言语音转文字</h2>

本项目基于 [VocoType](https://vocotype.com) 的 CLI 开源版本改造而成，感谢原作者的开源贡献。在原版基础上增加了多音源输入、多语言识别、分段流式输出等功能。

**VocoType CLI 修改版** 是一款离线语音转文字命令行工具，支持麦克风录音、系统声音捕获、音频文件转写三种输入方式。默认使用本地离线识别，所有识别均在本地完成，不上传任何数据。也支持可选的火山引擎云端识别后端。
